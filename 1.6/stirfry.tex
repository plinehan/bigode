...
the steady vigorous focus of a true culinary Jedi\index{jedi}. if you can find lemongrass, 
you can add it to the boiling water. the tea/soup this makes is excellent and 
vital for your continued survival on this disintegrating planet\index{planet!disintegrating} --- MAKE SURE 
...
fools and lovers\index{love!lover} are ready to eat, stir in the freshly cracked black pepper 
...
in the initial recipe, being a brasilian\index{brasil} restaurant, i cooked the polenta 
with coconut and lemongrass. if you're not in brasil\index{brasil} you probably won't 
...
\subsubsection{lily\index{lily}'s polenta breakfast}

so there's this girl lily\index{lily} who lived with us for months and months and it's 
...
kinds of breakfasty additions in your exotic\index{exotic} corn porridge.
...
happen to be selling on the culture\index{culture} channel.
...
\begin{ingredients}
  ...
  \item white\index{color!white} wine
  \item onions, diced
  \item garlic, minced
  \item basil, chopped
  \item cheese, grated
...
white wine\index{color!white} (if that's legal and desirable for you) or water. if you don't have 
...
your onions and garlic together on medium heat until they go from white\index{color!white} to 
...
when The All is One\index{One!the All is} pour into a tray or baking dish to cool (as directed 
...
\begin{ingredients}
  ...
  \tin{broccoli}, cauliflower, beets, cucumbers, green tomatoes)
  \item garlic
  \item ginger
\end{ingredients}
wash all your vegetables and peel the pestilential ones. cut them into thin longish slices that accentuate their shape and color\index{color}. be adventuresome and don't worry about the forks of your fellow men and women. they will find a way.
...
pineapple or other fleshies can go in last. the key is to cook everything\index{everything} 
exactly to the right texture so nothing is raw and nothing is mushy.

when everything\index{everything} is almost done, turn down the heat and add your sauce: 
either the peanut sauce (below) or any variation you see fit. mix together 
on low heat for a minute or two, until everything\index{everything} is cooked perfectly and has 
...
into your true, eternal\index{eternal}, selfhood.
...
\begin{algorithm}
  ...
  \begin{ingredients}
    ...
    \item body- mind- and spirit- altering chemicals\index{chemical} (nutrients, pesticides) congregate in the peel. you may want to remove it.
  ...
  \item appreciate them. the color\index{color}, the size, the texture.
  \begin{ingredients}
    \item there are millions of US who do not eat when we want to.
    \item there are millions of US who only eat the insides of cans and boxes. artificial colors\index{color} and illusionary sizes.
  ...
  \begin{ingredients}
    \item just for a minute until they begin to release they're goodness. you don't have to use them either. you don't have to do \tin{anything} you don't want to, regardless of what the police or your middle school teacher tried to tell you.
  \end{ingredients}

  \item fry everything\index{everything} else in order of size and hardness.
  \begin{ingredients}
    ...
    \begin{ingredients}
      ...
      \item bell peppers of various colors\index{color}
      \item cabbage
      \item cauliflower
      \item \tin{broccoli}
      \item lotus root (if you're really living in style)
      \item bok choi (or \tin{anything} foreign that sounds like it's from a 
      stirfry culture\index{culture})
      \item mushrooms
	\end{ingredients}
  \end{ingredients}
...
are prison to your ideological beliefs and can't find any organic\index{organic} non-gmo 
...
the chemical\index{chemical} premise is that the high heat steams out the internal water of 
...
onions and peppers or carrots or peppers and carrots or \tin{broccoli} or carrots 
...
many cultures\index{culture} prefer to cook their vegetables on lower heat for a slower 
...
burning and everything\index{everything} mixes together softly and easily. these vegetables are 
...
clinical distilled white\index{color!white} you'd take home from The Store.
...
one of the most popular dishes (among gringos) at O \tin{Bigode}, this salad 
marinates thinly prepared vegetables with a powerful\index{powerful} dressing.

\begin{ingredients}
  \item healthy cabbage
  \item bunch of carrots
  \item pair of beets
  \item green and white\index{color!white} onion
  \item sesame seeds
\end{ingredients}
...
\begin{ingredients}
  ...
  \item thinly slice white\index{color!white} onion
...
grating \tin{robot}) any vegetables together, let them soak with some good flavors, 
and enjoy.
...
\begin{ingredients}
  \item orange\index{color!orange} juice
  \item soy sauce
  \item honey
...
clearly this dish would be hard to do without the carrots. everything\index{everything} else is 
...
with just apple-cider vinegar as well. i never saw a pear in brasil\index{brasil} but little 
...
about three tries. the key is to \tin{balance} the creamyfatty taste of the peanuts 
...
take your roasted peanuts and put them in your \tin{robot}. plug in and turn on.
...
evolution\index{evolution} of the holy coconut, actually, it is the coconut water that 
...
letting the result simmer in coconut milk while you prepare everything\index{everything} else:
...
you can get a lot of insight into a culture\index{culture} from its markets and thriftstores. 
one device you could find in every kitchen/restaurant supply store in salvador 
looked like a horizontal orange\index{color!orange} juicer mounted on a hand crank (or electric), 
cost 40 points\index{points}, and was used to grind out the meat of a coconut. so all you 
have to do is split it with your \useGlosentry{facao}{fac\~{a}o}, drain the agua, mount it on the provided bracket, and crank 
...
luckily, the recipe adapts well (as in, hell, everything\index{everything} adapts well if we 
...
and everything\index{everything}.

let the seeds pop and roast in the oil and take off the heat when browned. 
grind in a \tin{mortar} and pestle until powdered. there will be some fragmentary 
...
\subsubsection{sweet and spicy \useGlosentry{aguacate}{aguacates}}

guacamole, while famous in mexico and everywhere else, is basically unheard of 
in brasil\index{brasil}. they have many types of avocados, delicious and smooth, and never 
...
\subsubsection{\useGlosentry{abacate}{doce de abacate}:}

\begin{ingredients}
  \item mix together until creamy
  \item as sweet as you can take it (the brasilians\index{brasil} take it pretty sweet) and 
