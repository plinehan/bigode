...
\textit{graced by}\\
roasted orange\index{color!orange} tomato salsa}
...
(new york apartments?) complain about the smell (goddamn\index{god!damn} immigrants taking 
over this county!) and it's no longer sexy to eat with your hands anyway.

though it's still more civilized. contrary to the \useGlosentry{idees recues}{id\'{e}es 
re\c{c}ues} of 
...
so all i had for the crowds of brasilian\index{brasil} vegetarians pounding on the blue\index{color!blue} 
...
goddess\index{god!goddess} murals --- and large green peppers, not too twisted and asking to be 
filled.
...
\begin{ingredients}
  ...
  \item ginger
  \item dill
  \item white\index{color!white} wine if you're fancy, hedonistic, and not cooking for muslims
  \item suco de \useGlosentry{limao}{lim\~{a}o}
\end{ingredients}
...
of green on white\index{color!white} (my operational hypothesis: your tastebuds and eyes are so 
unified in their \tin{aesthetic} sensibilities that the right color\index{color} \tin{balance} will 
...
any leftover white\index{color!white} wine (according to the proclivities and majority status of 
your dinner guests) to the filling.

if it's still cloudy or taboo don't go another minute thinking that you can't 
or shouldn't add white\index{color!white} wine or whatever \tin{alcohol} you want really to any food at 
any stage in the cooking process. you can and should, subject to personal 
morality of course.

unless it's for a salad dressing most of the \tin{alcohol} will cook off anyhow, but 
\tin{alcohol} is particularly good
...
want to use cheap leftover white\index{color!white} wine that's going to vinegar anyhow, and even 
...
cultures\index{culture} with a deep appreciation of food complexity and lots of spare female 
...
will melt and the beginning of its browning will let you know Everything\index{everything} is 
Ready.
...
reheat virtually \tin{anything} that was good yesterday, mix in something perky 
(finely diced onion, lemon juice, cilantro), and use as stuffing with a little 
parmesan cheese on top.

in brasil\index{brasil}, besides peppers (see above) we often used tomatoes, which require 
careful excavation and no-baking. in addition to standard get-down-in-there 
stuffing, O \tin{Bigode} --- being situated a mere twenty feet from the historic 
colonial seaport of Aratuba --- was no stranger to vegetative boats. the 
planet\index{planet} and i both like the `nautical style' vegetable stuffing technique 
...
cases less than if you were planning on mashing \tin{anything}.
...
up the squash with The One\index{One!and the Other} hand and eat out of it with The Other.
...
\mbox{\hskip1cm}and\\
\mbox{\hskip2cm}\textsf{\tin{100\% NEGRO}}
...
great. i like the potatoes more with onions and saut\'{e}ed greens. everything\index{everything} 
...
cold metal tentacles, sometimes it's good to make a stranger (or \tin{amanda}) smile.
...
\begin{ingredients}
  ...
  \item a little lemon juice or white\index{color!white} wine
\end{ingredients}
...
\begin{ingredients}
  ...
  \item some bread crumbs, smashed up tortilla chips, or \tin{anything} else crunchy and nutritionless
...
then cover immediately with a frisbee\index{frisbee}. mix in two bits of salt and olive oil 
...
\section{roasted orange\index{color!orange} tomato salsa}

a lot of cooking is about color\index{color}. this is a beautiful roasted tomato salsa that 
came out so nicely because the tomatoes were \gls{meio verde, meio madura}, a vibrant 
orange\index{color!orange} that might mean ``don't buy/use me yet'' if had we other options. we 
had not.
...
blisters off. i think they have a nice color\index{color}, taste, and texture, so i'll chop 
...
and chiles (of various species and colors\index{color}), so too are most roasted ones. 
...
as always, experiment. \tin{anything} you've done with fresh tomatoes or fresh 
chiles will be great with roasted tomatoes or roasted chiles. \tin{anything} that 
...
pulsing red\index{color!red} belly underneath. this is the meat to be eaten naked(ly), dunked 
...
\subsection{variations on the orange\index{color!orange} tomato salsa}
...
a unique flavor. in brasil\index{brasil} we used unripe red\index{color!red} tomatoes which were, in fact, 
...
mix everything\index{everything} together in a \tin{mortar} or blend in a few seconds with the \tin{robot}. 
...
\begin{ingredients}
  \item a base of roasted red\index{color!red} bell peppers
  \item a few roasted red\index{color!red} chile peppers
