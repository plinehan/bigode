...
\begin{ingredients}
  \item a pressure cooker\index{pcook} full of black-eyed peas\\
  \textrm{or}\\
...
black-eyed peas. there should be enough green, white\index{color!white}, and red\index{color!red} to
...
lunch. i always make a full pcooker\index{pcook} of beans even if i don't want so
...
powerful\index{powerful} nutritional undercurrent. each bean is a unique and holy
...
i know it sounds strange but it's awesome and the best color\index{color} you could
find. ever.
...
\begin{ingredients}
  ...
  \item optional white\index{color!white} wine
...
\begin{algorithm}
  ...
  \tin{balance} between the beets and tahini, blend in the adzuki beans.

  \item continue blending, using the adzuki bean cooking water, white\index{color!white}
...
that COOKING IS SO EASY. you don't even have to do \tin{anything} --- some
remote ancestral God\index{god} and an army of Mexican farm workers have
...
or ``bisque'' but then you have to wash the \tin{robot}. if you're feeling
...
goddamn\index{god!damn} point if it's so self-evident. but, to quote robert hass, ---

\smallskip
\makebox[1cm]{}After a while I understood that,\\
\makebox[1cm]{}talking this way, everything\index{everything} dissolves: justice,\\
\makebox[1cm]{}pine, hair, woman, you and I
\smallskip

--- and everything\index{everything} we do in this beautiful human tragedy is so petty
and obvious anyhow (and therein lies its majesty) that i damn well
better write this chapter.

so, soup. we didn't make many soups in brasil\index{brasil} because it was always so
...
as is generally the case, everything\index{everything} gets more interesting with a hit
...
at this point, a white\index{color!white} elephant\index{elephants} saunters into the room and reminds you
that NO SIR you are actually making a soup. down goes the heat
(medium-low) and in go the liquids --- pcooked\index{pcook} black beans, a few
...
--- or \tin{anything} quick-cooking to flavor the broth.

please, for the One\index{One!Love} Love\index{love!One Love}, do not use a processed cancer pill flavor
...
a little cayenne pepper or crushed red\index{color!red} pepper flakes makes the world
go around with this one. i also like to serve it with raw diced
onions, fresh ground toasted cumin, and grated cheese.

\subsubsection{lily\index{lily}'s thai soup}

now lily\index{lily} is really beyond the scope of this book. i'll try to do some
...
light glaze. cook a few minutes more and transfer to the \tin{robot}. blend
with a little soy sauce, vegetable stock, and whatever cream (dairy or
coconut) floats your roots.

if by any stroke of cosmic\index{cosmic} luck you have fennel available, use it. you
