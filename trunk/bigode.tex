...
\newcommand{\mypreface}[2]{\chapter*{\chaptergraphics{#1}\\#2}}
%                                       * nice horizontal rule.  * the graphic.          % nice horizontal rule.           * first page of chapter on odd page, with no page numbering on back page.
\newcommand{\mychapter}[3]{\chapter[#2]{\hrule height 1ex\bigskip\chaptergraphics{#1}\\#3\bigskip\bigskip\hrule height 1ex}\clearpage{\pagestyle{empty}\cleardoublepage}}
