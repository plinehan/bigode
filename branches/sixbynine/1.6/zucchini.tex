...
\section{brasilian\index{brasil} hummus}
\glsadd{hummus}
...
our brasilian\index{brasil} \gls{hummus} was very similar to the traditional middle
...
\subsubsection{white\index{color!white} canellini bean spread aux herbes fra\^{i}ches}
\glsadd{aux herbes fraiches}
